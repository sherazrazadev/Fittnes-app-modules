...
# Define functions to handle user input and workout generation
def get_user_input():
    level = input("Enter your fitness level (beginner, intermediate, advanced): ").lower()
    goal = input("Enter your goal (muscle building,  weight loss , gain weight, improve flexibility, increase endurance/stamina, gain strength, senior/olders fittness, mental wellness, weight maintenance ): ").lower()
    return level, goal
